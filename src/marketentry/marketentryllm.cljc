(ns marketentry.marketentryllm
  ...
  the North Macedonia (MKD) public-sector market-entry compliance
  actor.
...
(defn- propose-submit
  ...
  (let [e (store/engagement db subject)]
    {:summary    (str subject " 向けポータル提出提案"
                      (when e (str " (operator=" (:operator e) ")")))
     :rationale  (if e
                   (str "embs-verified?=" (:embs-verified? e)
                        " tax-arrears-amount=" (:tax-arrears-amount e)
                        " tax-deferred-payment-approved?=" (:tax-deferred-payment-approved? e)
                        " tax-deferred-payment-current?=" (:tax-deferred-payment-current? e)
